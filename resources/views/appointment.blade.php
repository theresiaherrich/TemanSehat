...
<link rel="stylesheet" href="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/css/select2.min.css') }}">

<link rel="stylesheet" href="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/css/bootstrap-datetimepicker.min.css') }}">
...
<li class="nav-item">
<a href="#" aria-expanded="false" class="nav-link active"><span>Clinic Consultation</span></a>
</li>
<!-- <li class="nav-item">
...
<input data-date-format="dd/mm/yyyy" id="datepicker" class="cal-input"> <i class="far fa-calendar-alt input-icon"></i>
</div>
</div>
</div>
<div class="form-group">
...
<li>10:00am - 11:30pm</li>
<li>11:30pm - 02:00pm</li>
<li>02:30pm - 03:00pm</li>
</ul>
</div>
...
<script src="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/js/bootstrap-datetimepicker.min.js') }}"></script>
