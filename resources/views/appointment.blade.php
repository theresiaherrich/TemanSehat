    ...
    <header class="mobile-header">
        ...
        <div class="page_title">
            <a href="index.html"><img
                    src="{{ asset('medilabf/medifab.dreamguystech.com/lightblue/assets/img/logo.png') }}" alt="Logo"
                    class="img-fluid" width="60" height="60"></a>
        </div>
    </header>
