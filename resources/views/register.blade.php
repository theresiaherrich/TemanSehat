...
<!-- Mirrored from Teman Sehat Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 06:09:32 GMT -->
<head>
<meta charset="utf-8">
...
<body>
	...
	<header class="header">
		...
		<div class="logo">
		<a title="Teman Sehat="Logo" src="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/img/logo.png') }}" width="308" height="61"></a>
		</div>
		</div>
		<div class="col-md-10">
