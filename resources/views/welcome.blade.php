...
<link rel="stylesheet" href="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/css/owl.carousel.css') }}">
<link rel="stylesheet" href="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/css/owl.theme.default.min.css') }}">
...
<h1>Teman Sehat</h1>
<p>Teman sehat merupakan web penyedia fasilitas tambahan untuk UKS sekolah dalam bidang kesehetan</p>
<a title="Konsultasi" class="btn btn-primary Konsultasi-btn" href="appointment.html">Konsultasi</a>
</div>
</div>
</div>
</div>
...
<div class="line"></div>
<p>Teman sehat merupakan web penyedia fasilitas tambahan untuk UKS sekolah dalam bidang kesehetan, yang bertujuan untuk memudahkan murid berkomunikasi/konsultasi dengan pihal UKS. Kami berharap dengan adanya Teman Sehat ini dapat membantu semaksimal mungkin :)</p>
</div>
</div>
</div>
-<div class="row">
	...
	<div class="dept-box">
	<div class="dept-img">
	<img width="67" height="80" alt="Dentists" src="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/img/uks.jpeg') }}"></a>
	</div>
	<h4>UKS</h4>
	<p>Usaha Kesehatan Sekolah (UKS) adalah upaya untuuk membina dan mengembangkan kebiasaan hidup sehat yang dilakukan secara terpadu 
	...
	<div class="dept-box">
	<div class="dept-img">
	<img width="63" height="80" alt="Appointment" src="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/img/appointment.png') }}"></a>
	</div>
	<h4>Appointment</h4>
...
<section class="section meet-doctors">
	...
	yang akan memberikan informasi tentang kesehatan dan mealayani keluhan kesehatan masyarakat sekolah.</p>
	</div>
	</div>
	</div>
	<div class="item">
	...
	<img src="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/img/diagnosis.png') }}" alt="Bu Tania" class="rounded-circle" width="170" height="170">
...
@include('footer')
		...
		<script data-cfasync="false" src="{{asset('medilabf/medifab.dreamguystech.com/lightblue/../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js') }}"></script><script src="assets/js/jquery-3.5.1.min.js"></script>
