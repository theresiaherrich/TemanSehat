...
<!-- Mirrored from Teman Sehat.dreamguystech.com/lightblue/doctor-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 06:09:32 GMT -->
<head>
<meta charset="utf-8">
...
<span>Bu. Tania Sandoval MBBS, FRCS</span>
</div>
</div>
</div>
</div>
...
<h4 class="doctor-name">Bu. Tania Sandoval MBBS, FRCS</h4>
<p>
<span class="depart">Konsultan</span>
</p>
</div>
...
<h3 class="sub-title">Tentang Konsultan</h3>
<p>Merupakan Kepala konsultan yang menjaga unit kesehatan sekolah dan menangani masalah kesehatan sekolah </p>
</div>
...
<h4>UKS  - SMK 8 (2016 to 2023)</h4>
<div>menjadi Kepala konsultan</div>
</div>
</li>
<li>
</li>
...
<div class="content">
	...
	<div class="doctor-details">
	<div class="doctor-info">
	<h4 class="doctor-name">Dr. mithas Sandoval MBBS, FRCS</h4>
	<p>
	<span class="depart">Staff Konsultan</span>
	</p>
	</div>
	<ul class="social-list">
	<li>
	...
	<div class="about-doctor">
	<h3 class="sub-title">Tentang Konsultan</h3>
	<p>Mmerupakan staff konsultan yang bergerak dalam Obat obatan.</p>
	...
	<div class="content">
		...
		<div class="doctor-details">
		<div class="doctor-info">
		<h4 class="doctor-name">Dr. Theresia Sandoval MBBS, FRCS</h4>
		<p>
		<span class="depart">Staff Konsultan</span>
		</p>
		</div>
		...
		<div class="about-doctor">
		<h3 class="sub-title">Tentang Konsultan</h3>
		<p>merupakan staff konsultan yang bergerak di bidang ketrampilan hidup sehat .</p>
		</div>
		<div class="experience-widget">
		<h3 class="sub-title">Experience</h3>
		<div class="experience-box">
		...
		<div class="content">
			...
			<div class="doctor-details">
			<div class="doctor-info">
			<h4 class="doctor-name">Dr. Berinda Sandoval MBBS, FRCS</h4>
			<p>
			<span class="depart"> Staff Konsultan</span>
			</p>
			</div>
			...
			<div class="about-doctor">
			<h3 class="sub-title">Tentang Konsultan</h3>
			<p>merupakan staff konsultan yang bergerak di bidang kesehatan pribadi dan lingkungan.</p>
			</div>
			<div class="experience-widget">
			<h3 class="sub-title">Experience</h3>
			<div class="experience-box">
			...
			<div class="content">
				...
				<div class="doctor-details">
				<div class="doctor-info">
				<h4 class="doctor-name">Dr. Cristina Groves MBBS, FDS</h4>
				<p>
				<span class="depart">Konsultan</span>
				</p>
				</div>
				...
				<div class="content">
					...
					<div class="doctor-list doctor-view">
					<div class="doctor-inner">
					<img class="img-fluid" alt src="{{asset('medilabf/medifab.dreamguystech.com/lightblue/assets/img/doctor-06.jpg">
					<div class="doctor-details">
					<div class="doctor-info">
					<h4 class="doctor-name">Dr. Henry Daniels MBBS, FDS</h4>
					<p>
					<span class="depart">Konsultan</span>
					</p>
					</div>
