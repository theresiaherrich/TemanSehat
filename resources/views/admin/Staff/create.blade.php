                                ...
                                @csrf
                                 <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                       ...
                                       <input type="date" class="form-control" id="ttl" name="ttl" placeholder="TTL">
                                    </div>
                                    <div class="form-group col-md-6">
                                       <label for="telp">Telp
                                    ...
                                    <div class="form-group col-sm-12">
                                       <label>Jenis Kelamin:</label>
                                        <br><input type="radio" name="jeniskelamin" value="cowo" required="" /> LAKI-LAKI
                                        <br><input type="radio" name="jeniskelamin" value="cewe" required="" /> PEREMPUAN
                                    </div>
