								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/avatar/1.jpg') }}" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/avatar/2.jpg') }}" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/avatar/3.jpg') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/avatar/4.jpg') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/avatar/5.jpg') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/avatar/1.jpg') }}" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/avatar/2.jpg') }}" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media me-2">
														<img alt="image" width="50" src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/avatar/1.jpg') }}">
													</div>
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link ai-icon" href="javascript:;"  role="button" data-bs-toggle="dropdown">
                                    <svg class="svg-multi-color"width="25" height="25" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:;" role="button" data-bs-toggle="dropdown">
                                    <img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/profile/12.png') }}" width="20" alt="">
									<div class="header-info">
										<span>Hello,<strong> Idris</strong></span>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
