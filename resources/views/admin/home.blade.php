...
<!-- Mirrored from eres.dexignzone.com/laravel/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 06:26:20 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>

	   <!-- Title -->
	<title>TemanSehat | Dashboard</title>
	...
	<meta property="og:description" content="ERES Laravel | Dashboard">
	...
	<link rel="shortcut icon" type="image/png" href="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/favicon.png') }}">
					...
					<link href="{{ asset('eres/eres.dexignzone.com/laravel/demo/../../../cdn.lineicons.com/2.0/LineIcons.css') }}" rel="stylesheet" type="text/css"/>
...
<div class="container-fluid">
    <div class="form-head d-flex mb-3 mb-md-4 align-items-start">
        <div class="me-auto d-none d-lg-block">
            <h3 class="text-black font-w600">Selamat Datang Admin!</h3>
            <p class="mb-0 fs-18">Admin TemanSehat</p>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-xxl-4 col-lg-4">
            <div class="card">
                <div class="card-header border-0 pb-0">
                    <h3 class="fs-20 mb-0 text-black">Obat</h3>
        ...
        <div class="col-xl-9 col-xxl-8 col-lg-8">
            <div class="card">
                <div class="card-header d-sm-flex d-block border-0 pb-0">
                    <h3 class="fs-20 mb-3 mb-sm-0 text-black">Pasien Grafik</h3>
        ...
        <div class="col-xl-9 col-xxl-8 col-lg-7">
            <div class="card">
                <div class="card-header border-0 pb-0">
                    <h3 class="fs-20 mb-0 text-black">Staff TemanSehat</h3>
                    <a href="page-review.html" class="text-primary font-w500">Selengkapnya >></a>
                </div>
                <div class="card-body">
                    <div class="assigned-doctor owl-carousel">
                        <div class="items">
                            <div class="text-center">
                                <img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/doctors/5.jpg') }}" alt="" >
                        ...
                        <div class="items">
                            <div class="text-center">
                                <img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/doctors/1.jpg') }}" alt="" >
                        ...
                        <div class="items">
                            <div class="text-center">
                                <img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/doctors/2.jpg') }}" alt="" >
                        ...
                        <div class="items">
                            <div class="text-center">
                                <img  src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/doctors/3.jpg') }}" alt="" >
                        ...
                        <div class="items">
                            <div class="text-center">
                                <img src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/doctors/4.jpg') }}" alt="" >
        ...
        <div class="col-xl-3 col-xxl-4 col-lg-5">
            <div class="card border-0 pb-0">
                <div class="card-header flex-wrap border-0 pb-0">
                    <h3 class="fs-20 mb-0 text-black">Pasien Terbaru</h3>
                    <a href="patient-list.html" class="text-primary font-w500">Selengkapnya >></a>
                </div>
                        ...
                        <ul class="timeline">
                            <li>
                                <div class="timeline-panel flex-wrap">
                                    <div class="media me-3">
                                        <img class="rounded-circle" alt="image" width="50" src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/widget/1.jpg') }}">
                                    </div>
                                    <div class="media-body">
                                        <h5 class="mb-1"><a class="text-black" href="patient-details.html">Aziz Bakree</a></h5>
                                        <span class="fs-14">24 Years</span>
                                    </div>
                                    <a href="javascript:void(0);" class="text-warning mt-2">Mengunggu</a>
                                </div>
                            </li>
                            <li>
                                <div class="timeline-panel flex-wrap">
                                    <div class="media me-3">
                                        <img class="rounded-circle" alt="image" width="50" src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/widget/2.jpg') }}">
                                    </div>
                                    <div class="media-body">
                                        <h5 class="mb-1"><a class="text-black" href="patient-details.html">Griezerman</a></h5>
                                        <span class="fs-14">24 Years</span>
                                    </div>
                                    <a href="javascript:void(0);" class="text-primary mt-2">Diterima</a>
                                </div>
                            </li>
                            <li>
                                <div class="timeline-panel flex-wrap">
                                    <div class="media me-3">
                                        <img class="rounded-circle" alt="image" width="50" src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/widget/3.jpg') }}">
                                    </div>
                                    <div class="media-body">
                                        <h5 class="mb-1"><a class="text-black" href="patient-details.html">Oconner</a></h5>
                                        <span class="fs-14">24 Years</span>
                                    </div>
                                    <a href="javascript:void(0);" class="text-danger mt-2">Ditolak</a>
                                </div>
                            </li>
                                <li>
                                <div class="timeline-panel flex-wrap">
                                    <div class="media me-3">
                                        <img class="rounded-circle" alt="image" width="50" src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/images/widget/5.jpg') }}">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="timeline-panel flex-wrap">
                                    ...
                                    <a href="javascript:void(0);" class="text-warning mt-2">Menunggu</a>
                                </div>
                            </li>
                            <li>
                                <div class="timeline-panel flex-wrap">
    ...
    ***********************************-->
    <!-- Required vendors -->
                    ...
                    <script src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/vendor/apexchart/apexchart.js') }}" type="text/javascript"></script>
                    <script src="{{ asset('eres/eres.dexignzone.com/laravel/demo/public/js/dashboard/dashboard-1.js') }}" type="text/javascript"></script>
